...
import 'package:child_goods_store_flutter/pages/edit_child/widgets/edit_child_tag.dart';
...
class _EditChildPageState extends State<EditChildPage> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<EditChildBloc, EditChildState>(
      listener: (context, state) {
        ...
        if (state.status == ELoadingStatus.loaded) {
          context.pop<GoRouterExtraModel<ChildModel>>(GoRouterExtraModel(
            data: state.result,
          ));
        }
      },
